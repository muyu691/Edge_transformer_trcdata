#!/bin/bash
# GPU Slurm launcher for the Edge Transformer new-attr-only ablation on Vera.

#SBATCH -J abl_newa
#SBATCH -o logs/abl_newa_%j.out
#SBATCH -e logs/abl_newa_%j.err
#SBATCH -t 0-12:00:00
#SBATCH -n 1
...
RUN_TAG="${RUN_TAG:-ablation_new_attr_only_${DATASET_NAME}_10000}"
...
echo "============ Edge Transformer New Attr Only (Vera GPU) ============"
...
srun python main.py \
  ...
  topology_gnn.alignment_mode "new_attr_only" \
