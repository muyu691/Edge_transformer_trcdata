#!/bin/bash
# GPU Slurm launcher for the unshared-diffusion-cells ablation on Vera.
...
RUN_TAG="${RUN_TAG:-unshared_diffusion_cells_${DATASET_NAME}}"
...
echo "============ Unshared Diffusion Cells (Vera GPU) ============"
