...
if [[ "${DATASET_NAME}" == "siouxfalls" ]]; then
  INPUT_PKL="${INPUT_PKL:-${PROCESSED_ROOT}/siouxfalls_pairs_newpolicy_lhs/network_pairs_dataset.pkl}"
elif [[ "${DATASET_NAME}" == "ema" ]]; then
  INPUT_PKL="${INPUT_PKL:-${PROCESSED_ROOT}/ema_pairs_newpolicy_lhs/network_pairs_dataset.pkl}"
else
