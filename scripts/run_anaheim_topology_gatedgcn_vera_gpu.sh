#!/bin/bash
# GPU Slurm launcher for the Anaheim TopologyGNN-GatedGCN baseline on Vera.
# This is the old ST-PINN-style control: same topology/physics framework,
# but local_backbone=gatedgcn instead of edge_transformer.

#SBATCH -J gate_ana
#SBATCH -o logs/gate_ana_%j.out
#SBATCH -e logs/gate_ana_%j.err
#SBATCH -t 1-00:00:00
#SBATCH -n 1
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/results/baselines/topology_gatedgcn}"
RUN_TAG="${RUN_TAG:-topology_gatedgcn_anaheim_10000}"
...
echo "============= TopologyGNN-GatedGCN Anaheim (Vera GPU) ============="
